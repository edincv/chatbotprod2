...
texto=req.body.input.text;
    ...
    request("https://orquestadorbot-infonavit.mybluemix.net/voicebotvivienda?texto="+texto+"&contexto="+JSON.stringify((req.body.context||{})), function(error, response, body) {
        console.log("La espuesta de bot es:");
        respuesta=response;
        console.log("**************APP.JS request***********************");
...
app.get('/mensaje', function(req, res) {
    ...
    var workspaceId = url_parts.query.workspaceId;
    console.log("*********************************LA SOLICITUD ES ***********************************");
    console.log(query);
    ...
    var respuesta;
    var request = require("request");
    request("https://orquestadorbot-infonavit.mybluemix.net/webbotvivienda?texto="+query+"&contexto="+JSON.stringify(contexto)+"&workspaceId="+workspaceId, function(error, response, body) {
        console.log("La espuesta de bot es:");
        console.log(body);
...
//_____----___----____----EDIN-------_____------_____----
