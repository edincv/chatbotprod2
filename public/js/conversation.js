...
var ConversationPanel = (function () {
  ...
  function linkify(text) {
    ...
    return cadena.replace(exp, "<a href='$1' target='_blank'>Enlace</a>");
  }
  //EDIN
  function guardaFeedback() {
    ...
    var auxIndice = lastUserMsg.length - 2;
    var pregunta = lastUserMsg[auxIndice].children[0].children[0].innerHTML;
  ...
  function setupInputBox() {
    ...
    // Any time the input changes, or the window resizes, adjust the size of the
    // input box
  ...
  function displayMessage(newPayload, typeValue) {
    ...
    if (typeValue === "watson") {
      ...
      //REMPLAZA LOS LINKS CON HTML TAGS
    newPayload.texto = "" + linkify(newPayload.texto);
    ...
    //GUARDA EL WORKSPACE ID
    document.getElementById("workspaceIdAux").value = newPayload.workspaceId;
    ...
    if (isUser !== null && textExists) {
      ...
      //EDIN
      if (newPayload.muestraFeedback === true) {
      ...
      scrollToChatBottom();
      var input = document.getElementById('textInput');
      if (newPayload && newPayload.conversationEnd === true) {
  ...
  // This is done so that the "context" of the conversation is maintained in the
  // view,
  ...
  function inputKeyDown(event, inputBox) {
    ...
    if (event.keyCode === 13 && inputBox.value) {
      ...
      var workspaceId = document.getElementById("workspaceIdAux").value;

      // Send the user message
      Api.sendRequest(inputBox.value, context, workspaceId);
